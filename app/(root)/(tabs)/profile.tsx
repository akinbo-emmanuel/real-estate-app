...
const Profile = () => {
  const { currentUser, refetch } = useGlobalContext();
  ...
  const handleLogout = async () => {
    ...
    if (result) {
      ...
      Alert.alert("Error", "An error eccurred while logging out.");
    }
  };
      ...
      >
        ...
        <View className="flex-row justify-center flex mt-5">
          <View className="flex flex-col items-center relative mt-5">
            ...
            <Text className="text-2xl font-rubikBold mt-2">{currentUser?.name}</Text>
          </View>
        </View>
